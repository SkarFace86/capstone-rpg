...
public class LayoutAnchor : MonoBehaviour
{
    ...
    /*
     * When positioning our RectTransform, we will need to know the general offsets to use
     * based on the location of the anchor we want and the size of the RectTransform’s rect.
     * Let’s make a method which allows us to get this information
     * from either of the RectTransforms we might want to pass to it
     */
    Vector2 GetPosition(RectTransform rt, TextAnchor anchor)
    {
        ...
        switch (anchor)
        {
            ...
            case TextAnchor.MiddleCenter:
            case TextAnchor.MiddleRight:
                retValue.y += (rt.rect.height) / 2.0f;
                break;
