...
public class WalkMovement : Movement
{
    ...
    {
        Tweener tweener = transform.MoveTo(target.center + new Vector3(0, halfExtents, 0), 0.5f, EasingEquations.Linear);
        while (tweener != null)
            yield return null;
    }
    IEnumerator Jump(Tile to)
    {
        ...
        //Tweener tweener = transform.MoveTo(to.center + new Vector3(0, halfExtents, 0), 0.5f, EasingEquations.Linear);
